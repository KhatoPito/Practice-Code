...
//        public Node<T> Reverse_N_M_Nodes(Node<T> head, int m, int n)
//        {
...
//            Node<T> prevMNode = head;
//            Node<T> futureNode = null;
//            int count = 1;
...
//            while (m-- > 1)
//            {
//                prevMNode = currentNode;
//                currentNode = currentNode.next;
//            }

//            tailNode = currentNode;
//            while (currentNode != null && count++ < n-m)
//            {
//                nextNode = currentNode.next;
//                currentNode.next = prevNode;
//                prevNode = currentNode;
...
//            tailNode.next = futureNode;

//            if (n == 1) return prevNode;
...
//            Node<int> obj = list.Reverse_N_M_Nodes(list.Head, 1,1);
